...
#PS1='${VIM:+✌ }${__error_ps1:-}${__jobs_ps1:-}${__user_ps1:-\u@\h:}\w$(__git_ps1)\$ '
PS1='\[\e]0;\u@\h: \w\a\]${VIM:+✌ }\[\e[1;31m\]${__error_ps1:-}\[\e[0m\e[0;34m\]${__jobs_ps1:-}\[\e[0m\]${__user_ps1:-}\w\[\e[0;32m\]$(__git_ps1)\[\e[0m\]\$ '
